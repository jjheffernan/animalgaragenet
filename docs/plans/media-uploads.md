...
When edge traffic justifies it, mirror `docs/media-cdn-plan.md`: same `media_assets.storage_path` convention, swap presign implementation to S3, keep DB schema.

## Related docs

- `docs/media-cdn-plan.md` — long-term CDN / Garage origin
- `docs/supabase.md` — auth and service role usage

...
Readiness assessment for wiring animalgaragenet to the Saleor backend at `commerce.animalgarage.net`.
...
- No integration tests against live `commerce.animalgarage.net` (env-gated only)
...
| File | Action |
| ---- | ------ |
| `docs/saleor-audit.md` | Updated — June 29, 2026 verification pass |
...
See also: [saleor.md](./saleor.md), [mock-to-saleor.md](./style-guide/business-logic/mock-to-saleor.md).

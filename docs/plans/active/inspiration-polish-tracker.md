...
| IP-013 | inspiration         | CDN Phase 2 (S3 + CloudFront)                | `src/lib/server/media/cdn.ts`                                                    | **partial**   | **Upload scaffold done** — presigned PUT + `/admin/media`; CloudFront invalidation deferred |

...
| AUD-P2-021 | daisyUI skill tree removal (post sign-off)      | agents-skills-audit       | **done** | docs       | Tree deleted; see `docs/audits/zinc-only-deps-audit.md`                            | `skills-lock.json`                                                      |

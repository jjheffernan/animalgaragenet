...
| AUD-P2-012 | Site-wide SEO / OG / analytics                  | site-audit, STATUS        | **done** | code    | Consent-gated `trackPageView` in root layout; provider wiring deferred               | `src/lib/analytics.ts` · `+layout.svelte`                                |

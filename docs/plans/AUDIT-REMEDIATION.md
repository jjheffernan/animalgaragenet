...
| AUD-P2-012 | Site-wide SEO / OG / analytics                  | site-audit, STATUS        | **partial** | code    | Per-route meta on shop/parts/builds/media; analytics hook (Phase 5) deferred     | `PageMeta.svelte` · `+layout.svelte` · BATCH-016                          |

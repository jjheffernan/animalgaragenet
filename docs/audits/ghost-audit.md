...
See [content/ghost.md](../content/ghost.md) for setup and tag conventions.
...
Documented in [content/ghost.md](../content/ghost.md) and enforced in `mappers.ts` + `fetchPostBySlug()`.

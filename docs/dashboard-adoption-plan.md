...
Saleor remains headless on `commerce.animalgarage.net`; admin only **reads** via GraphQL (mutations for catalog later).
...
*Related docs:* [phase3-plan.md](./phase3-plan.md), [saleor.md](./saleor.md), [supabase.md](./supabase.md), [auth-oauth.md](./auth-oauth.md), [build-submissions.md](./build-submissions.md)

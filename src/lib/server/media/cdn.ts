...
// @inspiration-scaffold: intentional — see docs/plans/active/inspiration-polish-coordination.md#IP-013
/**
...
// @migration: intentional — presigned PUT for admin /admin/media upload UI; see docs/plans/active/inspiration-polish-coordination.md#IP-013
...
// @migration: intentional — CloudFront invalidation after asset replace; see docs/plans/active/inspiration-polish-coordination.md#IP-013

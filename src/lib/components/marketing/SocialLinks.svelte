...
<div class="flex items-center gap-2 {className}">
	{#each links as link (link.href)}
		<a
			...
			class="flex h-9 w-9 items-center justify-center rounded-sm border border-zinc-800 bg-zinc-900/50 text-zinc-500 transition hover:border-red-600/50 hover:bg-zinc-900 hover:text-red-500"
